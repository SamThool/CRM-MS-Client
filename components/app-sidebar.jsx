...
const navByTeam = {
  ...
  MASTER: [
    ...
    { title: "Bank Details", url: "/master/bankdetails", icon: Landmark },
    {
    ...
    { title: "Lead Reference", url: "/master/lead-reference", icon: Link2 },
    { title: "Lead Status", url: "/master/lead-status", icon: Kanban },
    { title: "Lead Type", url: "/master/lead-type", icon: ShapesIcon },
    { title: "Lead Source", url: "/master/lead-source", icon: Radio },
    {
      title: "Graduation",
    ...
    { title: "Designation", url: "/master/designation", icon: IdCard },
    { title: "sector", url: "/master/sector", icon: Building2 },
    { title: "size", url: "/master/size", icon: Ruler },
    { title: "Priority", url: "/master/priority", icon: Flag },
    { title: "Task Status", url: "/master/task-status", icon: CheckCircle2 },
  ],
};
